...
export const getNumberOfProspecting = createAsyncThunk(
  "prospecting/getNumberOfProspecting",
  async () => {
    ...
    const params = {
      limit: prospectingState.itemsPerPage,
      page: prospectingState.currentPage,
    };
    return axios
      .get(url, {
        headers: headers,
