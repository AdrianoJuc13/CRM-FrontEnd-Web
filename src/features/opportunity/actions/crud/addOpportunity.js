...
export const addOpportunity = createAsyncThunk(
  ...
  async ({
    ...
    const url = configState.backendHostname + "/opportunities";
    ...
    const data = {
      ...
      nisa_id: nisaId,
      marime_opportunity_id: marimeOpportunityId,
      activitate_opportunity_id: activitateOpportunityId,
